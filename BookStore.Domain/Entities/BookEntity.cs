...
{
    public BookEntity(string title, string publishedDate, string thumbnailUrl, string shortDescription,
    ...
    [NotMapped] public List<string> AuthorsList => Authors.Split(',').ToList();

    [NotMapped] public List<string> CategoriesList => Categories.Split(',').ToList();
